...
class Element(HtmlElement):
    ...
    def alias(self):
        if self._alias is not None:
            return self._alias
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import alias
    ...
    def selector(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import selector
    ...
    def children(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import children
    ...
    def siblings(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import siblings
    ...
    def descendants(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import descendants
    ...
    def parent_selector(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import selector, parent
    ...
    def path(self):
        ...
        if self._path is not None:
            return self._path
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import path
    ...
    def path_raw(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import path_raw
    ...
    def number_of_char(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import number_of_char
    ...
    def number_of_a_descendants(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import number_of_a_descendants
    ...
    def number_of_a_char(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import number_of_a_char
    ...
    def number_of_p_descendants(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import number_of_p_descendants
    ...
    def number_of_punctuation(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import number_of_punctuation
    ...
    def number_of_children(self):
        ...
        self._number_of_children = len(self.children)
        return self._number_of_children
    ...
    def number_of_siblings(self):
        ...
        self._number_of_siblings = len(self.siblings)
        return self._number_of_siblings
    ...
    def number_of_descendants(self):
        ...
        self._number_of_descendants = len(self.descendants)
        return self._number_of_descendants
    ...
    def density_of_punctuation(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import density_of_punctuation
    ...
    def density_of_text(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import density_of_text
    ...
    def similarity_with_siblings(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import similarity_with_siblings
    ...
    def a_descendants(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import a_descendants
    ...
    def a_descendants_group(self):
        ...
        from com.syj.cuiqingcai.chapter14.GerapyAutoExtractor.gerapy_auto_extractor.utils.element import a_descendants_group
    ...
    def a_descendants_group_text_avg_length(self):
        ...
        :return:
        """
        if self.a_descendants_group_text_avg_length is not None:
            return self.a_descendants_group_text_avg_length
        values = self.a_descendants_group_text_length.values()
        self.a_descendants_group_text_avg_length = mean(values) if values else 0
        return self.a_descendants_group_text_avg_length
