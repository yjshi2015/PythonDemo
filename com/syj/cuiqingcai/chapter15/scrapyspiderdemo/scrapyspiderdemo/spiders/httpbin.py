...
from scrapyspiderdemo.items import HttpbinDemoItem
...
class HttpbinSpider(scrapy.Spider):
    ...
    headers = {
        'User-Agent': 'syjMozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Safari/537.36'
    }
    ...
    # def start_requests(self):
    #     # form表单形式
    #     yield FormRequest(self.start_url, headers=self.headers, callback=self.parse_response, formdata=self.data)
    ...
    def parse_response(self, response):
        ...
        item = HttpbinDemoItem(**response.json())
        yield item
